# -*- coding: utf-8 -*-
"""
Created on Sun Nov  7 13:50:04 2021
...
from HSI_MaeModel import mae_vit_HSI_patch3, vit_HSI_patch3
...
for num in range(0,num_of_ex):
    ...
    for epoch in range(num_epoch):
        ...
        for idx, (x,y) in enumerate(train_loader):                        
            ...
            x = x.cuda()
            y = y.cuda()
            loss, _, _ = net(x, mask_ratio=mask_ratio)           
...
record.record_output(OA, AA, KAPPA, ELEMENT_ACC, TRAINING_TIME, TESTING_TIME,
                      ...
                      '_augment_' + str(args.augment) +'_aug_scale_' + str(args.scale) +'_decoder_dim_' + str(args.decoder_dim) + '_decoder_depth_' + str(args.decoder_depth)+ '.txt') 
